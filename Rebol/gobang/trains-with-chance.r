...
view layout [
	...
	panel 466x503 black [
		...
		panel 466x35 240.255.255 [
			...
			space 5x5
			across
			text "Training Times: " with [ size: 105x30 font/size: 14 ]
			times: field "1" 60
			button "Go" 60 [
				lp: to-integer times/text
				t: 1
				loop lp [
					status/text: rejoin [ "Training the " t "th set" ]
					show status
					t: t + 1
					while [true] [
						if myturn [
							...
							do rejoin reduce [ "C" choice/5 {/text: to-string index} ]
							click choice/5 myturn
